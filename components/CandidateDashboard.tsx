...
function resolveJobListingApplyUrl(
  ...
  if (source.includes("hiring") || source.includes("cafe"))
    return `https://hiring.cafe/viewjob/${jobId}`;
  if (source.includes("jobright"))
    return `https://jobright.ai/jobs/info/${jobId}`;
...
const StatusRenderer = ({ value }: { value?: string }) => {
  ...
  return (
    <div className="flex items-center h-full">
      <span
        className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold capitalize border ${variantMap[status] || variantMap.default}`}
      >
        {formatted || "N/A"}
      </span>
    </div>
    ...
    () => [
      {
        ...
        cellRenderer: (params: any) => (
          <div className="flex items-center h-full">
            <span className="font-bold text-gray-900 dark:text-gray-100 text-[13px]">
              {params.value}
            </span>
          </div>
        ),
      ...
      },
      {
        ...
        cellRenderer: (params: any) => {
          ...
          return (
            <div className="flex items-center h-full">
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium border ${style.bg} ${style.text} ${style.border}`}
              >
                {formattedValue}
              </span>
            </div>
    ...
    async (page: number) => {
      try {
        ...
        const res: any = await apiFetch(
          `positions/paginated?${params.toString()}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
            ...
            <div className="space-y-0.5">
              {tabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={`w-4 h-4 flex-shrink-0 ${isActive ? "text-blue-600 dark:text-blue-400" : "text-gray-400"}`}
                    />
                    <span>{tab.name}</span>
                    {isActive && (
              ...
              >
                <Sparkles
                  className={`w-4 h-4 flex-shrink-0 ${activeTab === "smartprep" ? "text-indigo-600 dark:text-indigo-400" : "text-gray-400"}`}
                />
              ...
              >
                <KeyRound
                  className={`w-4 h-4 flex-shrink-0 ${activeTab === "my_llm_key" ? "text-emerald-600 dark:text-emerald-400" : "text-gray-400"}`}
                  aria-hidden
                />
                <span>My LLM Key</span>
                {activeTab === "my_llm_key" && (
            ...
            <div className="hidden sm:flex items-center gap-8 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl px-8 py-5 shadow-sm">
              ...
              <div className="flex items-center gap-4 pr-6 border-r border-gray-100 dark:border-gray-700">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className="text-lg font-extrabold text-gray-900 dark:text-white leading-none whitespace-nowrap">
                    Hi, {firstName}
                  </h1>
              ...
              {[
                ...
                <div
                  key={label}
                  className={`hidden lg:flex flex-col gap-1 ${widthClass || "min-w-0"}`}
                >
              ...
              <div className="relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 px-6 py-3 border border-indigo-200 dark:border-indigo-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4 md:gap-6 flex-1">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <span className="text-xl font-extrabold text-indigo-950 dark:text-indigo-100 tracking-tight">
                      WBL{" "}
                    ...
                    <button
                      onClick={async () => {
                        ...
                        if (token) {
                          ...
                          alert(
                            "Preparing your secure session... Please click again in a moment.",
                          );
                        }
                      }}
          ...
          {data.alerts && data.alerts.length > 0 && (
            <div className="flex flex-wrap gap-2 px-4 lg:px-6 pt-4">
              {data.alerts.map((alert, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-2 px-3 py-2 rounded-xl border text-xs font-medium flex-1 min-w-[200px] ${
                    alert.type === "warning"
                        ...
                        <div className="relative px-2 py-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 relative z-10">
                            {[
                              ...
                              <div
                                key={idx}
                                className="flex flex-row md:flex-col items-center group relative"
                              >
                                {idx !== 3 && (
                                  <div className="md:hidden absolute left-[15px] top-8 bottom-[-24px] w-0.5 bg-gray-100 dark:bg-gray-700 -z-10" />
                                )}
                                <div
                                  className={`w-9 h-9 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-300 shadow-sm border-2 ${
                                ...
                                >
                                  <step.icon
                                    className={`w-4 h-4 ${step.status === "active" ? "animate-pulse" : ""}`}
                                  />
                                </div>
                                <div className="ml-4 md:ml-0 md:mt-3 text-left md:text-center flex-1">
                                  <div
                                    className={`text-[9px] font-bold uppercase tracking-widest mb-0.5 ${step.status === "completed" ? "text-blue-500" : step.status === "active" ? "text-blue-400" : "text-gray-300"}`}
                                  >
                                    Step 0{idx + 1}
                                  </div>
                                  <h3
                                    className={`text-xs font-bold mb-1 ${step.status === "upcoming" ? "text-gray-400" : "text-gray-900 dark:text-white"}`}
                                  >
                                    {step.title}
                                  </h3>
                                  <div className="min-h-[28px] flex flex-col justify-start md:items-center">
                                    ...
                                    {step.status === "active" &&
                                      step.duration && (
                                        <span className="mt-0.5 text-[9px] font-bold text-orange-500 uppercase tracking-wide">
                                          Day {step.duration}
                                        </span>
                                      )}
                                    {step.company && (
                                      <span className="mt-0.5 text-[9px] font-bold text-blue-500 truncate">
                                        {step.company}
                                      </span>
                                    )}
                                  </div>
                            ...
                            <div className="space-y-2">
                              {data.team_info.preparation.instructors.map(
                                (instructor, idx) => (
                                  <div
                                    key={idx}
                                    className="flex items-center gap-3 p-2.5 bg-gray-50 dark:bg-gray-800/60 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors group"
                                  >
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-5">
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2 relative z-50">
                          ...
                          <button
                            onClick={() => {
                              if (selectedRow) setViewData(selectedRow);
                            }}
                          ...
                          <button
                            onClick={() => {
                              if (selectedRow) {
                                ...
                                setEditInterviewForm({ ...selectedRow });
                              }
                            }}
                            disabled={!selectedRow}
                          ...
                          >
                            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-blue-300 dark:border-blue-800 w-full max-w-4xl overflow-hidden">
                              ...
                              <div className="flex items-center justify-between px-6 py-2.5 border-b border-blue-200 dark:border-blue-900 bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-darklight dark:via-dark dark:to-darklight">
                                <h3 className="text-base font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                                  Add New Interviews
                                </h3>
                                <button
                                  onClick={() => setShowAddInterview(false)}
                                  className="text-blue-300 hover:text-blue-500 transition-colors text-2xl font-light"
                                >
                                  ×
                                </button>
                              </div>
                              ...
                              <div className="p-6 max-h-[80vh] overflow-y-auto">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6">
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div>
                                      <label className="block text-[14px] font-bold text-blue-600 dark:text-blue-400 mb-1">
                                        Company{" "}
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div>
                                      ...
                                      <select
                                        value={
                                          addInterviewForm.mode_of_interview
                                        }
                                        onChange={(e) =>
                                          setAddInterviewForm((p) => ({
                                            ...p,
                                    ...
                                    <div>
                                      ...
                                      <select
                                        value={
                                          addInterviewForm.type_of_interview
                                        }
                                        onChange={(e) =>
                                          setAddInterviewForm((p) => ({
                                            ...p,
                              ...
                              <div className="p-6 max-h-[80vh] overflow-y-auto">
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div>
                                      ...
                                      <input
                                        ...
                                        className="w-full rounded-lg border border-blue-200 dark:border-blue-800 bg-gray-50 dark:bg-gray-800/50 px-3 py-1.5 text-sm focus:outline-none cursor-default"
                                      />
                                    </div>
                                    <div>
                                      <label className="block text-[14px] font-bold text-blue-600 dark:text-blue-400 mb-1">
                                      ...
                                      <input
                                        ...
                                        className="w-full rounded-lg border border-blue-100 dark:border-blue-800 bg-gray-50 dark:bg-gray-800/50 px-3 py-1.5 text-sm focus:outline-none cursor-default"
                                      />
                                    </div>
                                    <div>
                                      <label className="block text-[14px] font-bold text-blue-600 dark:text-blue-400 mb-1">
                                ...
                                <div className="mt-8 border-t border-blue-50 dark:border-blue-900/50 pt-6">
                                  ...
                                  <textarea
                                    ...
                                    className="w-full h-32 rounded-lg border border-blue-200 dark:border-blue-800 bg-gray-50 dark:bg-gray-800/50 px-4 py-3 text-sm focus:outline-none resize-none cursor-default"
                                  />
                                </div>
                                <div className="mt-4">
                                  <label className="block text-[14px] font-bold text-blue-600 dark:text-blue-400 mb-2">
                                ...
                                <div className="mt-10 pt-4 border-t border-blue-50 dark:border-blue-900 flex justify-end gap-3">
                                  <button
                                    onClick={() => setViewData(null)}
                                    className="px-8 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all shadow-md"
                                  >
                                    Close
                                  </button>
                                </div>
                          ...
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="hidden sm:flex items-center gap-5">
                              <div className="flex items-center gap-2">
                                ...
                                <span
                                  className={`text-sm font-bold ${data.interviews.filter((i) => i.interview_date && new Date(i.interview_date) >= new Date(new Date().setHours(0, 0, 0, 0))).length > 0 ? "text-green-600" : "text-gray-300"}`}
                                >
                                  {
                                    data.interviews.filter(
                                      (i) =>
                      ...
                      <div className="flex-shrink-0 flex flex-wrap items-center justify-end gap-4 px-4 py-2.5 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-gray-600 dark:text-gray-300 px-2">
                            Page <span className="font-bold">{jobsPage}</span>{" "}
                            of{" "}
                            <span className="font-bold">
                              {Math.max(1, jobsTotalPages)}
                            </span>
                          </span>
                          <button
                            type="button"
                          ...
                          <button
                            ...
                            disabled={!jobsHasNext || positionsLoading}
                            onClick={() =>
                              setJobsPage(Math.max(1, jobsTotalPages))
                            }
                            className="inline-flex items-center justify-center rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 p-1.5 text-gray-700 dark:text-gray-200 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                          >
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-5">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            setSetupWizardManageMode(
                              Boolean(setupStatus?.setup_complete),
                            );
                            setSetupWizardOpen(true);
                          }}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${setupStatus === null ? "bg-gray-100 dark:bg-gray-700" : setupStatus.resume_uploaded ? "bg-emerald-100 dark:bg-emerald-900/40" : "bg-amber-100 dark:bg-amber-900/40"}`}
                          >
                            {setupStatus === null ? (
                          ...
                          <div className="min-w-0">
                            ...
                            <p
                              className={`text-xs font-bold mt-0.5 ${setupStatus === null ? "text-gray-400" : setupStatus.resume_uploaded ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"}`}
                            >
                              {setupStatus === null
                                ? "Loading..."
                                : setupStatus.resume_uploaded
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${setupStatus === null ? "bg-gray-100 dark:bg-gray-700" : setupStatus.api_keys_configured ? "bg-emerald-100 dark:bg-emerald-900/40" : "bg-amber-100 dark:bg-amber-900/40"}`}
                          >
                            {setupStatus === null ? (
                              <div className="w-3 h-3 rounded-full bg-gray-300 animate-pulse" />
                            ) : setupStatus.api_keys_configured ? (
                          ...
                          <div className="min-w-0">
                            ...
                            <p
                              className={`text-xs font-bold mt-0.5 ${setupStatus === null ? "text-gray-400" : setupStatus.api_keys_configured ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"}`}
                            >
                              {setupStatus === null
                                ? "Loading..."
                                : setupStatus.api_keys_configured
...
const PhaseCard = ({
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 border ${borderColor} rounded-xl p-3 shadow-sm transition-all duration-200`}
    >
      <div className="flex items-center gap-2.5 mb-3">
        <div className={`${accentColor}`}>{icon}</div>
        <h3 className="text-xs font-extrabold text-gray-900 dark:text-gray-100 tracking-tight uppercase leading-tight">
          {title}
        </h3>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="pt-2 border-t border-gray-50 dark:border-gray-700 space-y-1.5">
          ...
          {batchName && (
            <p className="text-xs font-bold text-gray-600 dark:text-gray-400 truncate flex items-center gap-1.5">
