...
type TabType = 'overview' | 'sessions' | 'interviews' | 'jobs' | 'smartprep' | 'my_llm_key' | 'my-llm-key' | 'my_applications' | 'ai_setup' | 'my-llm-setup' | 'my_resume' | 'my-resume';
