...
//           `${process.env.NEXT_PUBLIC_API_URL}/interviews`
//         );
//         // ✅ Use items array from paginated response
...
//                         {/* NEW: Mode + Type of Interview */}
//                         {/* <div className="mt-1 flex flex-col text-sm">
//                           <span>
//                             <strong>Mode:</strong>{" "}
//                             {interview.mode_of_interview || "N/A"}
//                           </span>
//                           <span>
//                             <strong>Type:</strong>{" "}
//                             {interview.type_of_interview || "N/A"}
//                           </span>
//                         </div> */}
//                       </div>
//                     ))}
  ...
  return (
    <>
      ...
      <motion.div
        ...
        transition={{ type: "spring", stiffness: 70, damping: 15 }}
        className={`fixed left-0 top-0 ${isDark ? "bg-gradient-to-b from-gray-900 to-indigo-800 text-gray-100" : "bg-gradient-to-b from-purple-200 via-purple-300 to-indigo-300 text-gray-900"} h-full z-[9999] shadow-2xl ${sidebarOpen ? "w-80" : "w-0"}`}
      ...
      >
        <div className="flex flex-col h-full pb-32">
          ...
          <div className={`py-4 text-center border-b ${isDark ? "border-gray-700 bg-black/30" : "border-white/10 bg-black/10"} backdrop-blur-sm sticky top-0 z-10`}>
            <h2 className={`font-bold text-2xl ${isDark ? "bg-gradient-to-r from-gray-300 to-indigo-500 bg-clip-text text-transparent" : "bg-gradient-to-r from-purple-500 via-indigo-500 to-indigo-600 bg-clip-text text-transparent"}`}>
              Dashboard
            </h2>
          </div>
          ...
          <nav className="mt-6 flex-grow px-6">
            <div className="space-y-1.5">
              {/* Recent Interviews */}
              <button
                className={`sidebar-item w-full flex items-center p-2.5 rounded-lg transition-all duration-300 ${activeSection === "announcements" ? `${isDark ? "bg-white/10" : "bg-white/30"} font-medium` : `${isDark ? "text-gray-300 hover:bg-white/5" : "text-gray-800 hover:bg-white/20"}`}`}
                onClick={() => setActiveSection("announcements")}
              >
              ...
              {/* Recent Placements */}
              <button
                className={`sidebar-item w-full flex items-center p-2.5 rounded-lg transition-all duration-300 ${activeSection === "placements" ? `${isDark ? "bg-white/10" : "bg-white/30"} font-medium` : `${isDark ? "text-gray-300 hover:bg-white/5" : "text-gray-800 hover:bg-white/20"}`}`}
                onClick={() => setActiveSection("placements")}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
