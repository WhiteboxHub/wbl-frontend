...
//   source_email: "Professional Information",
...
// //   promissory: "Basic Information",
// //   full_name: "Basic Information",
// //   extraction_date: "Basic Information", // ✅ added here
...
// //   // Contact Info
// //   location: "Contact Information", // ✅ keep location
// //   vendor_phone: "Contact Information",
// //   vendor_secondary_phone: "Contact Information",
...
// //   spouseemail: "Spouse Email",
// //   spouseoccupationinfo: "Spouse Occupation Info",
// //   extraction_date: "Extraction Date", // ✅ label override
// // };
...
// //   const toLabel = (key: string) => fieldLabels[key] || key;
...
// //   const modalWidthClass =
// //     { 1: "max-w-xl", 2: "max-w-3xl", 3: "max-w-5xl", 4: "max-w-6xl" }[columnCount] ||
// //     "max-w-6xl";

// //   const gridColsClass =
// //     { 1: "grid-cols-1", 2: "md:grid-cols-2", 3: "md:grid-cols-3", 4: "lg:grid-cols-4 md:grid-cols-2" }[
// //       columnCount
                ...
                {sectionedFields[section].map(({ key, value }) => (
                  <div key={key} className="space-y-1">
                    ...
                    <div className="text-gray-900 dark:text-gray-100">
                      {dateFields.includes(key.toLowerCase()) && value
