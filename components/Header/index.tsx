...
//                     <button
//                       onClick={display_user_dashboard}
//                       className="rounded-md bg-gradient-to-br from-indigo-900 to-purple-400 py-3 px-6 text-sm font-bold text-white transition duration-500 hover:bg-opacity-90"
//                     >
//                       My Profile
//                     </button>
//                     <button
...
//                     <Link
//                       href="/login"
//                       className="hover:shadow-signUp mr-3 rounded-md bg-gradient-to-br from-indigo-900 to-purple-400 py-3 px-8 text-base font-bold text-white duration-500 hover:bg-opacity-90 hover:bg-gradient-to-tl hover:from-indigo-900 hover:to-purple-400"
//                     >
//                       Login
//                     </Link>
//                     <Link
//                       href="/signup"
//                       className="hover:shadow-signUp rounded-md bg-gradient-to-br from-indigo-900 to-purple-400 py-3 px-8 text-base font-bold text-white duration-500 hover:bg-opacity-90 hover:bg-gradient-to-tl hover:from-indigo-900 hover:to-purple-400"
//                     >
//                       Register
//                     </Link>
//                   </>
...
//                         <li className="lg:hidden">
//                           <button
//                             className="my-3 block rounded-3xl bg-gradient-to-tl from-indigo-900 to-purple-400 py-3 px-5 text-center text-base font-bold text-white hover:bg-gradient-to-br hover:from-indigo-900 hover:to-purple-400"
//                             onClick={() => {
//                               closeNavbar();
//                               display_user_dashboard();
//                             }}
...
//                           <Link
//                             href="/signup"
//                             className="block rounded-3xl bg-gradient-to-tl from-indigo-900 to-purple-400 py-3 px-5 text-center text-base font-bold text-white hover:bg-gradient-to-br hover:from-indigo-900 hover:to-purple-400"
//                             onClick={closeNavbar}
//                           >
//                             Register
//                           </Link>
...
//                     <button
//                       onClick={display_user_dashboard}
//                       className="rounded-md bg-gradient-to-br from-indigo-900 to-purple-400 py-3 px-7 text-base font-bold text-white transition duration-500 hover:bg-opacity-90"
//                     >
//                       My Profile
//                     </button>
//                     <button
...
// whiteboxLearning-wbl\components\Header\index.tsx
import Image from "next/image";
import Link from "next/link";
import { useEffect, useState } from "react";
import ThemeToggler from "./ThemeToggler";
                  ...
                  {isAuthenticated && (
                    <li className="lg:hidden">
                      <button
                        ...
                        className="my-3 block w-full rounded-3xl bg-gradient-to-tl from-indigo-900 to-purple-400 py-2 px-3 text-center text-sm font-bold text-white hover:bg-gradient-to-br sm:text-base"
                      >
                        My Profile
                      </button>
                    </li>
                  ...
                  {isAuthenticated ? (
                    ...
                    <>
                      <li className="lg:hidden">
                        <Link
                          href="/login"
                          className="my-3 block rounded-3xl bg-gradient-to-tl from-indigo-900 to-purple-400 py-2 px-3 text-center text-sm font-bold text-white hover:bg-gradient-to-br sm:text-base"
                          onClick={closeNavbar}
                        >
                          Login
                        </Link>
                      ...
                      <li className="lg:hidden">
                        <Link
                          href="/signup"
                          className="block rounded-3xl bg-gradient-to-tl from-indigo-900 to-purple-400 py-2 px-3 text-center text-sm font-bold text-white hover:bg-gradient-to-br sm:text-base"
                          onClick={closeNavbar}
                        >
                          Register
                        </Link>
