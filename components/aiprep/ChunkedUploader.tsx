...
export const ChunkedUploader: React.FC<ChunkedUploaderProps> = memo(({
  ...
  return (
    <div
      ...
      className="w-full max-w-md p-4 bg-white/95 dark:bg-[#1D2144]/95 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-[#333756] shadow-xl space-y-3 transition-all text-gray-800 dark:text-gray-100"
    >
