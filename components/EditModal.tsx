...
//   course_name: "Professional Information",
//   subject_name: "Basic Information",
//   // Add course material specific fields
//   cm_course: "Basic Information",
...
//           headers: { Authorization: `Bearer ${token}` },
//         });
//         // Sort courses by ID in descending order to show latest first, then set default
...
//           headers: { Authorization: `Bearer ${token}` },
//         });
//         // Sort subjects by ID in descending order to show latest first, then set default
...
//   Object.entries(formData).forEach(([key, value]) => {
//     // For course material modal, exclude subject_id, course_id, and type fields
//     if (isCourseMaterialModal && ["subjectid", "courseid", "type"].includes(key.toLowerCase())) {
//       return;
//     }
...
//                     <>
//                       {/* Course Dropdown - Latest data first, default to Machine Learning */}
//                       <div className="space-y-1">
//                         <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
//                           Course Name
//                         </Label>
...
//                           ) : (
//                             <>
//                               {/* Default option - Machine Learning */}
//                               <option value="Machine Learning">Machine Learning</option>
//                               {/* Other courses sorted by latest first */}
//                               {courses
//                                 .filter(course => course.name !== "Machine Learning")
//                                 .map((course) => (
//                                   <option key={course.id} value={course.name}>
//                                     {course.name}
//                                   </option>
...
//                       {/* Subject Dropdown - Latest data first, default to Basic Fundamentals */}
//                       <div className="space-y-1">
//                         <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
//                           Subject Name
//                         </Label>
...
//                           ) : (
//                             <>
//                               {/* Default option - Basic Fundamentals */}
//                               <option value="Basic Fundamentals">Basic Fundamentals</option>
//                               {/* Other subjects sorted by latest first */}
//                               {subjects
//                                 .filter(subject => subject.name !== "Basic Fundamentals")
//                                 .map((subject) => (
//                                   <option key={subject.id} value={subject.name}>
//                                     {subject.name}
//                                   </option>
...
//                         </Label>
//                         <select
//                           value={formData["material_type"] || formData["type"] || ""}
//                           onChange={(e) => 
...
//   Object.entries(formData).forEach(([key, value]) => {
//     // For course material modal, only exclude the raw type field (we're using material_type instead)
//     // But keep subjectid and courseid as they are needed for mapping
