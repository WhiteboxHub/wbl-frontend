...
//         const filteredVideos = Array.isArray(response.data.batch_recordings)
//         ? response.data.batch_recordings
//           : [];
...
// // whiteboxLearning-wbl\components\Recording\SearchComp.tsx
// import React, { useState, useRef, useCallback, useEffect } from "react";
// import { debounce } from "lodash";
// import axios from "axios";
// import { useSearchParams } from "next/navigation";
...
//   const searchParams = useSearchParams();
//   const course = searchParams.get("course") as string;
//   const batchid = searchParams.get("batchid") as string; // ✅ Added batchid
...
//   useEffect(() => {
//     if (!course || !batchid) {
//       setError("Course or batchid parameter is missing from the URL.");
//       return;
//     }

//     // Reset state when course or batchid changes
//     setSearchQuery("");
//     setSearchResults([]);
//     setShowSearchBox(false);
//     setSelectedVideo(null);
...
//             `${process.env.NEXT_PUBLIC_API_URL}/recording`,
//             {
//               params: { course, batchid, search: query }, // ✅ batchid included
//               cancelToken: cancelTokenRef.current.token,
//             }
//           );
...
//       }
//     }, 500),
//     [course, batchid] // ✅ Added batchid dependency
//   );
