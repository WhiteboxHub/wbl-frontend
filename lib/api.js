...
export async function apiFetch(endpoint, options = {}) {
  ...
  if (!res.ok) {
    ...
    if (
      ...
      errorBody.detail.onboarding
    ) {
      try {
        localStorage.setItem("onboarding_status", JSON.stringify(errorBody.detail.onboarding));
      } catch {}
    }
...
export const setupApi = {
  /** GET /api/candidate/setup-status */
  getStatus: () => apiFetch("/api/candidate/setup-status"),
