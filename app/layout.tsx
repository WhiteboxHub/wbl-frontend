...
export default function RootLayout({
  ...
  return (
    <html suppressHydrationWarning lang="en" className={inter.className}>
      <head>
        {/* Blocking script to prevent FOUC - runs before page render */}
        <Script
          id="theme-script"
