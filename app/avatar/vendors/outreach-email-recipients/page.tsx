...
export default function OutreachEmailRecipientsPage() {
    ...
    const columnDefs: ColDef[] = useMemo(
        () => [
            ...
            { field: "email_invalid", headerName: "Invalid Email", width: 130, sortable: true, filter: "agTextColumnFilter", cellRenderer: BooleanRenderer, editable: true },
            { field: "domain_invalid", headerName: "Invalid Domain", width: 140, sortable: true, filter: "agTextColumnFilter", cellRenderer: BooleanRenderer, editable: true },
            { field: "unsubscribe_flag", headerName: "Unsubscribed", width: 140, sortable: true, filter: "agTextColumnFilter", cellRenderer: BooleanRenderer, editable: true },
            { field: "bounce_flag", headerName: "Bounced", width: 120, sortable: true, filter: "agTextColumnFilter", cellRenderer: BooleanRenderer, editable: true },
            { field: "complaint_flag", headerName: "Complaint", width: 120, sortable: true, filter: "agTextColumnFilter", cellRenderer: BooleanRenderer, editable: true },
