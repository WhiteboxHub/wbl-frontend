...
export default function EmailPositionsPage() {
    ...
    const sourceOptions = ['bot_linkedin_post_contact_extractor', 'bot_linkedin_message_extraction', 'email', 'linkedin', 'job_board', 'scraper', 'hiring.cafe', 'trueup.io', 'email_bot_llm_local', 'jobright'];
