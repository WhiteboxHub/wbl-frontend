...
// // //       >
// // //         <span className="ag-header-cell-text" style={{ cursor: 'pointer' }}>
// // //           Status
// // //         </span>
// // //       </div>
...
// // //           <span className="min-w-[18px] h-[18px] rounded-full bg-blue-500 px-1.5 text-center text-[10px] leading-[18px] text-white font-bold" style={{ marginRight: '4px' }}>
...
// // //           className="h-4 w-4"
// // //           style={{ color: selectedStatuses.length > 0 ? '#3b82f6' : '#6b7280' }}
// // //           fill="none"
// // //           viewBox="0 0 24 24"
// // //           stroke="currentColor"
// // //         >
...
// // //           <span className="min-w-[18px] h-[18px] rounded-full bg-green-500 px-1.5 text-center text-[10px] leading-[18px] text-white font-bold" style={{ marginRight: '4px' }}>
...
// // //           xmlns="http://www.w3.org/2000/svg"
// // //           className="h-4 w-4"
// // //           style={{ color: selectedWorkStatuses.length > 0 ? '#22c55e' : '#6b7280' }}
// // //           fill="none"
// // //           viewBox="0 0 24 24"
// // //           stroke="currentColor"
// // //         >
...
// // //           const leadStatus = (node.data.status || "").toLowerCase();
// // //           const statusMatch = selectedStatuses.some(
// // //             (status) => status.toLowerCase() === leadStatus
// // //           );
...
// // //           const leadWorkStatus = (node.data.workstatus || "").toLowerCase();
// // //           const workStatusMatch = selectedWorkStatuses.some(
// // //             (ws) => ws.toLowerCase() === leadWorkStatus
// // //           );
// // //           if (!workStatusMatch) return false;
// // //         }
...
// // //     }
// // //   }, [sortModel, loadLeadsFromIndexedDB]);
...
// // //         secondary_phone: data.secondary_phone ? cleanPhoneNumber(data.secondary_phone) : null,
...
// // //           payload.full_name = toPascalCase(payload.full_name);
// // //         }
// // //         if (payload.phone) {
// // //           payload.phone = cleanPhoneNumber(payload.phone);
// // //         }
// // //         if (payload.secondary_phone) {
// // //           payload.secondary_phone = cleanPhoneNumber(payload.secondary_phone);
// // //         }
...
// // //         <AGGridTable
// // //           key={`${leads.length}-${selectedStatuses.join(",")}-${selectedWorkStatuses.join(",")}`}
// // //           rowData={leads}
...
// // //                 secondary_phone: newRow.secondary_phone ? cleanPhoneNumber(newRow.secondary_phone) : "",
...
// // //                       className="w-full resize-y rounded-lg border border-blue-200 px-2 py-1.5 text-xs shadow-sm transition hover:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 sm:px-3 sm:py-2 sm:text-sm"
...
// // Real-time phone input formatting
...
//   // Watch for full_name changes to apply PascalCase in real-time
...
//         setValue("full_name", pascalCased);
//       }
//     }
...
//         // Apply PascalCase and phone cleaning
