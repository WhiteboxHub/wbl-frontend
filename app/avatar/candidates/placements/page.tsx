...
//     try {
//       // Strip id because backend takes it from path param
...
//       setFilteredCandidates((prev) => [...prev, res.data]);
//       setShowModal(false);
...
//     } catch (err) {
//       console.error(err);
//       alert("Failed to create placement. Try again.");
//     }
//   };
...
//     ) {
//       alert(
//         "Please fill all required fields: Candidate ID, Company, Placement Date, Status."
//       );
//       return;
//     }
...
// /////////////// above code is added placemnt successfully but name not visisble ////////////////////////////////////////
