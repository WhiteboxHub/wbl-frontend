...
export default function PersonalDomainContactsPage() {
    ...
    const columnDefs: ColDef[] = useMemo(
        () => [
            ...
            { field: "linkedin_id", headerName: "LinkedIn ID", width: 150, sortable: true, filter: "agTextColumnFilter", editable: true, valueParser: (params) => params.newValue === "" ? null : params.newValue },
