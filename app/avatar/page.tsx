            ...
            {metrics?.my_tasks && metrics.my_tasks.length > 0 && (
              <Card className="border-b border-indigo-200">
                <CardHeader className="p-3 pb-1">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-sm font-medium text-muted-foreground">
                      {metrics.my_tasks[0].employee_name ? `${metrics.my_tasks[0].employee_name}'s Tasks` : "My Assigned Tasks"}
                    </CardTitle>
            ...
            {metrics?.my_jobs && metrics.my_jobs.length > 0 && (
              <Card className="border-b border-blue-200">
                <CardHeader className="p-3 pb-1">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-sm font-medium text-muted-foreground">
                      {metrics.my_jobs[0].job_owner_name ? `${metrics.my_jobs[0].job_owner_name}'s Assigned Jobs` : "My Assigned Jobs"}
                    </CardTitle>
                      ...
                      <tbody>
                        {metrics.my_jobs.map((job) => (
                          <tr key={job.id} className="border-b transition-colors hover:bg-muted/30">
                            <td className="px-3 py-2 text-gray-500">{job.unique_id}</td>
